...
DESCRIPTION in a remote repository. The path must be a valid connection (on 
GitHub, this requires linking to the raw content of DESCRIPTION). You can test 
that the path works using `read.dcf(url(<path>))`.